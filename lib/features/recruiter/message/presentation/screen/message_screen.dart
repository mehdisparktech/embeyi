...
class RecruiterChatMessageScreen extends StatefulWidget {
  const RecruiterChatMessageScreen({super.key});

  @override
  State<RecruiterChatMessageScreen> createState() =>
      _RecruiterChatMessageScreenState();
}

class _RecruiterChatMessageScreenState
    extends State<RecruiterChatMessageScreen> {
